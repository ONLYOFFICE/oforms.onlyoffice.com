...
const DocumentTemplatesPage = ({ locale, sort, page, forms, categories, types, compilations, popularTemplates }) => {
...
export const getServerSideProps = async ({ locale, query }) => {
  ...
  const forms = await getExtForms(locale, page, sort, 9, "docx");
  ...
  const popularTemplates = await getPopularTemplates(locale, "docx", null, null);
