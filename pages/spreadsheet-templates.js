...
const SpreadsheetTemplatesPage = ({ locale, sort, page, forms, categories, types, compilations, popularTemplates }) => {
...
export const getServerSideProps = async ({ locale, query }) => {
  ...
  const forms = await getExtForms(locale, page, sort, 9, "xlsx");
  ...
  const popularTemplates = await getPopularTemplates(locale, "xlsx", null, null);
