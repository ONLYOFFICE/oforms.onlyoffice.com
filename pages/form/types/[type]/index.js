    ...
    <Layout locale={locale}>
      ...
      <Layout.SectionMain>
        <CategoryContent 
          ...
          categoryName={categoryInfo.data[0].type}
          categoryUrl={`form/types/${categoryInfo.data[0]?.urlReq}`}
...
export const getServerSideProps = async ({ locale, query }) => {
  ...
  const categoryForms = await getCategoryForms(locale, sort, page, 9, urlReq, "types");
  ...
  const popularTemplates = await getPopularTemplates(locale, null, urlReq, "types");
