        ...
        searchValue.length === 0 ? (
          <div className="search-results">
            {searchHistory?.length > 0 &&
              <Heading as="div" className="search-results-label" label={t("History")} size={6} />
            }
            {searchHistory?.map((item, index) => (
              <div onClick={() => setSearchResult(false)} className="search-results-item" key={index}>
                ...
                <button onClick={(e) => handleRemoveSearchHistoryItem(e, index)} className="search-results-btn" type="button">
            ...
            {popularSearch[locale].length > 0 &&
              <>
                <Heading as="div" className="search-results-label" label={t("Popular search")} size={6} />
