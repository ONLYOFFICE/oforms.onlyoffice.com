    ...
    <>
      ...
      <StyledMain>
        ...
        {docxForms.data.length > 0 &&
          <CardsBlock t={t} locale={locale} title={t("Document templates")} linkUrl={"/document-templates"} data={docxForms} />
        }
        {xlsxForms.data.length > 0 &&
          <CardsBlock t={t} locale={locale} title={t("Spreadsheet templates")} linkUrl={"/spreadsheet-templates"} data={xlsxForms} />
        }
        {pptxForms.data.length > 0 &&
          <CardsBlock t={t} locale={locale} title={t("Presentation templates")} linkUrl={"/presentation-templates"} data={pptxForms} />
        }
      </StyledMain>
    </>
  );
