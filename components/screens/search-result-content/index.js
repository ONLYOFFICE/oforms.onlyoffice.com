  ...
  return (
    <StyledSearchResultContent>
      ...
      {searchData.data?.length > 0 ? (
        <>
          <Heading className="search-result-title" level={1} size={2} label={searchQuery ? locale === "zh" ? `'${searchQuery}' ${t("Search results for")}` : `${t("Search results for")} '${searchQuery}'` : t("Search results")} />
