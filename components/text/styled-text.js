...
const fontText = css`
    ...
    ? "bold"
    : props.fontWeight || props.theme.text.fontWeight};
    font-style: ${(props) => props.isItalic
    ? "italic"
    : props.fontStyle || props.theme.text.fontStyle};
`;
...
const hoverText = css`
    ...
    && css`
        :hover {
            ...
            text-transform: ${(props) => props.hoverTextTransform || props.theme.text.hoverTextTransform};
            text-decoration: ${(props) => props.hoverTextDecoration || props.theme.text.hoverTextDecoration};
            text-shadow: ${(props) => props.hoverTextShadow || props.theme.text.hoverTextShadow};
