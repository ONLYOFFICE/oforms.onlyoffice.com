...
#navitem_latest_events, #navitem_features_latest_releases, #navitem_download_compare, #navitem_features_security, #navitem_integrations_jira,
#navitem_integrations_nextcloud, #navitem_integrations_owncloud, #navitem_integrations_confluence, #navitem_integrations_alfresco,
#navitem_integrations_sharepoint, #navitem_integrations_liferay, #navitem_integrations_humhub, #navitem_integrations_plone, #navitem_integrations_nuxeo, 
#navitem_integrations_chamilo, #navitem_integrations_redmine, #navitem_integrations_connectors, #navitem_integration_for_developers, #navitem_prices_reseller {
    padding: 0 32px;
    &:before {
		display: none;
	}
...
@media screen and (max-width: 1023px) {
    ...
    #compare_div, #for_developers_div, #latest_news_div, #reseller_div, #security_div, #latest_events_div {
        display: none;
    }
}
