...
const PresentationTemplatesPage = ({
  locale,
  popularForms,
  typeFormsCount,
  categories,
  ...
  const { t } = useTranslation("presentation-templates");
...
export const getServerSideProps = async ({
  ...
  const [
    ...
    getCategoriesWithFormsCount(locale, "categories", "categorie", "pptx"),
    getCategoriesWithFormsCount(locale, "types", "type", "pptx"),
    getCategoriesWithFormsCount(locale, "compilations", "compilation", "pptx"),
    getExtForms(locale, "pptx", sortQuery, 8, 1),
    activeTaxonomy
      ? getSubCategoryForms(
          locale,
          activeTaxonomy,
