...
const FormCategoryPage = ({
  ...
  categoryForms,
  categoryInfo,
}: ISubCategoryPage<"categorie"> & ILocale) => {
  const seoTitle =
    categoryInfo.data[0]?.attributes.seo_title ||
    categoryInfo.data[0]?.attributes.categorie;
...
export const getServerSideProps = async ({
  ...
  const [
    ...
    getCategoryForms(locale, "categories", urlReq as string, sortQuery, 8, 1),
    getCategoryInfo(locale, "categories", urlReq as string, "categorie"),
  ]);
