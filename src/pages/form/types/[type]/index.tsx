...
const FormTypePage = ({
  ...
  categoryForms,
  categoryInfo,
}: ISubCategoryPage<"type"> & ILocale) => {
  const seoTitle =
    categoryInfo.data[0]?.attributes.seo_title ||
    categoryInfo.data[0]?.attributes.type;
...
export const getServerSideProps = async ({
  ...
  const [
    ...
    getCategoryForms(locale, "types", urlReq as string, sortQuery, 8, 1),
    getCategoryInfo(locale, "types", urlReq as string, "type"),
  ]);
